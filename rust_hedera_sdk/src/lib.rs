...
#[no_mangle]
pub extern fn call_contract(input_operator: *const c_char, input_node_port: *const c_char, input_node_account: *const c_char, input_private_key: *const c_char, input_contract_id: *const c_char, input_gas: *const c_char, input_abi_path: *const c_char, input_function: *const c_char, input_amount: *const c_char, input_arguments: *const c_char) -> *const c_char {
    convert_to_UTF_16(call_contract_func(convert_to_UTF_8(input_operator),convert_to_UTF_8(input_node_port),convert_to_UTF_8(input_node_account),convert_to_UTF_8(input_private_key),convert_to_UTF_8(input_contract_id),convert_to_UTF_8(input_gas),convert_to_UTF_8(input_abi_path),convert_to_UTF_8(input_function),convert_to_UTF_8(input_amount),convert_to_UTF_8(input_arguments)))
}
